    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      ...
      >
        ...
        <p className="text-white/60 text-sm mb-6 leading-relaxed">
          Your browser has blocked microphone access for this site. Zoya cannot hear you, but you can still type commands directly in the input bar at the bottom!
        </p>
        
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-left w-full mb-8">
          <p className="text-sm text-white/80 font-medium mb-2">To enable microphone:</p>
        ...
        <div className="flex flex-col w-full gap-3">
          <button 
            ...
            className="w-full py-3 px-4 bg-[#00E5FF] text-black font-semibold rounded-xl hover:bg-[#00E5FF]/80 transition-colors cursor-pointer"
          >
            I've allowed it, Refresh Page
          </button>
          <button 
            onClick={onClose}
            className="w-full py-3 px-4 bg-white/10 text-white/80 font-medium rounded-xl hover:bg-white/20 transition-colors cursor-pointer"
          >
